...
class CreateName extends React.Component {
    ...
    return (
      <div className="CreateName">
        ...
        <form onSubmit={this.handleSubmit}>
          <div>
            <Input className="display" label="Your Display Name" />
          </div>
          <div>
            <Input className="native" label="Your preferred name in native script" />
          </div>
          <div>
            <label>
              Language locale
  ...
  handleSubmit(e) {
    var synth = window.speechSynthesis;
    //var inputForm = document.querySelector('form');
    var displayInputTxt = document.querySelector('.display input');
    var nativeInputTxt = document.querySelector('.native input');
